...
interface SubscriptionRepository : BaseRepository<Subscription> {
    fun findAllByUserIdAndDeletedFalse(userId: Long, pageable: Pageable): Page<Subscription>?
    fun findAllByUserIdAndDeletedFalse(userId: Long): List<Subscription>?
    fun findAllByFollowerIdAndDeletedFalse(followerId: Long, pageable: Pageable): Page<Subscription>?
    fun findAllByFollowerId(followerId: Long): List<Subscription>?
